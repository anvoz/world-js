define(function(require) {
  ...
  test('seed.move', function() {
    var world   = new WorldJS();
    var padding = world.padding;
    var speed   = 5;
    var pos     = padding + speed;
  ...
  test('seed.seek', function() {
    ...
    var seed = world.addSeed(Seed, { x: 50, y: 50 });
    ...
    var seedC = world.addSeed(Seed, {   x: pos.center,  y: pos.center });
    var seedT = world.addSeed(Seed, {   x: pos.center,  y: pos.top });
    var seedB = world.addSeed(Seed, {   x: pos.center,  y: pos.bottom });
    var seedL = world.addSeed(Seed, {   x: pos.left,    y: pos.center });
    var seedR = world.addSeed(Seed, {   x: pos.right,   y: pos.center });
    var seedTL = world.addSeed(Seed, {  x: pos.left,    y: pos.top });
    var seedTR = world.addSeed(Seed, {  x: pos.right,   y: pos.top });
    var seedBL = world.addSeed(Seed, {  x: pos.left,    y: pos.bottom });
    var seedBR = world.addSeed(Seed, {  x: pos.right,   y: pos.bottom });
