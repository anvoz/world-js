...
test('seed.seek', function() {
  ...
  var seedC = world.addSeed(world.Seed, {   x: pos.center,  y: pos.center });
  var seedT = world.addSeed(world.Seed, {   x: pos.center,  y: pos.top });
  var seedB = world.addSeed(world.Seed, {   x: pos.center,  y: pos.bottom });
  var seedL = world.addSeed(world.Seed, {   x: pos.left,    y: pos.center });
  var seedR = world.addSeed(world.Seed, {   x: pos.right,   y: pos.center });
  var seedTL = world.addSeed(world.Seed, {  x: pos.left,    y: pos.top });
  var seedTR = world.addSeed(world.Seed, {  x: pos.right,   y: pos.top });
  var seedBL = world.addSeed(world.Seed, {  x: pos.left,    y: pos.bottom });
  var seedBR = world.addSeed(world.Seed, {  x: pos.right,   y: pos.bottom });
